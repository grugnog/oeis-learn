...
- **Report ID**: `rep_009_1788661887`
- **Run ID**: `009`
- **Qualification State**: `BLOCKED`
- **Overall Passed**: `NO`
- **Evaluated At**: `2026-09-06T02:31:27.333492+00:00`
...
| `stage1_minimum_coverage` | `stage1_minimum_coverage` | `GE` | 0.5 | 0.5000 | ✓ PASS | YES |
| `stage1_competence_variance` | `stage1_competence_variance` | `LE` | 0.01 | 0.0000 | ✓ PASS | YES |
| `stage1_synthesis_pass_rate` | `stage1_synthesis_pass_rate` | `GE` | 0.8 | 0.0000 | ✗ FAIL | YES |
...
| `advantage_collapse_rate` | `advantage_collapse_rate` | `LE` | 0.05 | 1.0000 | ✗ FAIL | YES |
